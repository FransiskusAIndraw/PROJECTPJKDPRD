            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('tusekwan.dashboard') }}"
                       class="block rounded p-2 {{ request()->routeIs('tusekwan.dashboard') ? 'bg-blue-900 text-white font-semibold' : 'hover:bg-blue-600' }}">
                        Dashboard
                    </a>
                </li>
                <li>
                    <a href="{{ route('tusekwan.surat_masuk.index') }}" 
                        class="block rounded p-2 {{ request()->routeIs('tusekwan.surat_masuk.index') ? 'bg-blue-900 text-white font-semibold' : 'hover:bg-blue-600' }}">
                        Verifikasi Surat Masuk
                    </a>
                </li>
                <li>
                    <a href="{{ route('tusekwan.surat_masuk.search') }}" 
                        class="block rounded p-2 {{ request()->routeIs('tusekwan.surat_masuk.search') ? 'bg-blue-900 text-white font-semibold' : 'hover:bg-blue-600' }}">
                        Cari Surat 
                    </a>
                </li>
                <li>
                    <a href="{{ route('tusekwan.disposisi.index') }}" 
                        class="block rounded p-2 {{ request()->routeIs('tusekwan.disposisi.index') ? 'bg-blue-900 text-white font-semibold' : 'hover:bg-blue-600' }}">
                        Disposisi Surat
                    </a>
                </li>
            </ul>
