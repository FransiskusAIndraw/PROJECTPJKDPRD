...
class TUSekreSuratController extends Controller
{
    ...
    public function arsipkan($id)
    {
        ...
        // Ambil disposisi terakhir (jika ada)
        $disposisiTerakhir = $surat->disposisis()->latest()->first();

        Arsip::create([
            'surat_id'           => $surat->id,
            'disposisi_id'       => $disposisiTerakhir->id ?? null,
            'arsipkan_oleh'      => Auth::id(),
            'arsipkan_oleh_role' => Auth::user()->roles ?? 'tusekre',
            ...
            'instruksi'          => $disposisiTerakhir->instruksi ?? null,
