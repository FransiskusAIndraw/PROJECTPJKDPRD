...
<div class="p-6 max-w-3xl mx-auto">
    <h2 class="text-2xl font-bold mb-4">Detail Surat</h2>
    ...
    <div class="border rounded p-4 space-y-3">
        ...
        <p><strong>Catatan Disposisi:</strong> {{ $surat->latestDisposisi->catatan ?? '-' }}</p>
    ...
    <a href="{{ route('staff.surat.index') }}" class="mt-4 inline-block text-blue-600 hover:underline">← Kembali</a>
</div>
@endsection
